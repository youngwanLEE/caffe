...
#2016.12.27.
def CreateAnnotatedDataLayer_RRS(source, batch_size=32, backend=P.Data.LMDB,
        output_label=True, train=True, label_map_file='', anno_type=None,
        transform_param={}, batch_sampler=[{}], batch_sampling_strategy=''):
    print(batch_sampling_strategy)
    if train:
        kwargs = {
                'include': dict(phase=caffe_pb2.Phase.Value('TRAIN')),
                'transform_param': transform_param,
    ...
    annotated_data_param = {
        'label_map_file': label_map_file,
        'batch_sampler': batch_sampler,
        'sampling_strategy': batch_sampling_strategy
...
def Inception_v2_ResBody(net, from_layer, block_name, out2a,out2b_3,out2c_3,out_merge, stride, use_branch1):
  # ResBody(net, 'pool1', '2a', 64, 64, 256, 1, True)
  ...
  ConvBNLayer(net, from_layer, root_name, use_bn=True, use_relu=True,
      num_output=out2a, kernel_size=1, pad=0, stride=stride, use_scale=use_scale,
      conv_prefix=conv_prefix, conv_postfix=conv_postfix,
      bn_prefix=bn_prefix, bn_postfix=bn_postfix,
      scale_prefix=scale_prefix, scale_postfix=scale_postfix)
...
## by youngwan in 2016.10.10.
def Inception_v2_Res_Conv3x3_basic_l2_Cifar10(net, from_layer, global_pool=True):
    ...
    ResBasic33Body(net, 'res2c', '3a', out2a=256, out2b=256,  stride=2, use_branch1=True) # 32-->16
    #ResBasic33Body(net, 'res3a', '3a', out2a=512, out2b=512,  stride=1, use_branch1=False) # 38
    Inception_v2_ResBody(net,'res3a','3a',out2a=64, out2b_3=256,out2c_3=256,out_merge=256,stride=1,use_branch1=False)
...
## by youngwan in 2016.12.14.
# More-Wider-WR-Inception Networks
def Inception_v2_9_PreActRes_Conv3x3_basic_SSD(net, from_layer, global_pool=True):
    ...
    ResPreActivBody2(net, 'res2b', '3a', out2a=512, out2b=512,  stride=2, use_branch1=True) # 32-->16
    Inception_v2_PreActResBody_2nd(net,'res3a','3a',out2a=512, out2b_3=512,out2c_3_a=256,out2c_3_b=512,out_merge=512,stride=1,use_branch1=False)
...
# More-Wider-WR-Inception Networks
# WR-Inception-l4-m2
def Inception_v2_9_PreActRes_Conv3x3_basic_Cifar10(net, from_layer, global_pool=True):
...
def Inception_v2_Res_Conv3x3_basic_l2_SSD(net, from_layer, global_pool=True):
    ...
    #ResBasic33Body(net, 'res3a', '3a', out2a=512, out2b=512,  stride=1, use_branch1=False) # 38
    Inception_v2_ResBody(net,'res3a','3a',out2a=64, out2b_3=256,out2c_3=256,out_merge=256,stride=1,use_branch1=False) #38
...
def Inception_Res_Conv3x3_l2_v3_SSD(net, from_layer, global_pool=True):
    ...
    return net
## by youngwan in 2016.12.16.
# More-Wider-WR-Inception Networks
def Inception_v2_12_PreActRes_Conv3x3_basic_SSD(net, from_layer, global_pool=True):
    ...
    ResPreActivBody2(net, 'res2b', '3a', out2a=384, out2b=384,  stride=2, use_branch1=True) # 32-->16
    Inception_v2_PreActResBody_2nd(net,'res3a','3a',out2a=384, out2b_3=384,out2c_3_a=256,out2c_3_b=384,out_merge=384,stride=1,use_branch1=False)
    

    from_layer = 'inception_3a'
    ResPreActivBody2(net, from_layer, '4a', out2a=256, out2b=256, stride=2, use_branch1=True) # 16 --> 8   
    ResPreActivBody2(net, 'res4a', '4b', out2a=512, out2b=512,  stride=1, use_branch1=True)
...
# More-Wider-WR-Inception Networks
# WR-Inception-l4-m2
def Inception_v2_12_PreActRes_Conv3x3_basic_Cifar10(net, from_layer, global_pool=True):
