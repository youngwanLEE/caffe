...
train_data = "/home/youngwan/data/cifar100/cifar100-gcn-leveldb-splits/cifar100_full_train_leveldb_padded"
test_data = "/home/youngwan/data/cifar100/cifar100-gcn-leveldb-splits/cifar100_test_leveldb"
train_mean_file = "/home/youngwan/data/cifar100/cifar100-gcn-leveldb-splits/paddedmean.binaryproto"
test_mean_file = "/home/youngwan/data/cifar100/cifar100-gcn-leveldb-splits/mean.binaryproto"
...
job_name = "cifar_100_preActiv_resnet_15_basic_l4_SGDR"
# The name of the model. Modify it if you want.
#[LYW]
model_name = "cifar_100_{}".format(job_name) #model_name = "VGG_KITTI_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/CIFAR-100/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/CIFAR-100/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the job script and log file.
#[LYW]
job_dir = "jobs/CIFAR-100/{}".format(job_name)#job_dir = "jobs/VGGNet/KITTI/{}".format(job_name)
...
PreActiv_ResNet_15_Conv3x3_basic_l4_Cifar_100(net,from_layer='data',global_pool=True)

net.loss = L.SoftmaxWithLoss(net.fc100, net.label)
...
net.accuracy = L.Accuracy(net.fc100, net.label)
net.loss = L.SoftmaxWithLoss(net.fc100, net.label)
