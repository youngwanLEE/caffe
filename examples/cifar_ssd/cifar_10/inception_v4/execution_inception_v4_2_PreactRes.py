...
job_name = "inception_v4_2_PreactRes_cifar10"
# The name of the model. Modify it if you want.
#[LYW]
model_name = "cifar_10_{}".format(job_name) #model_name = "VGG_KITTI_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/CIFAR-10/inception_v4/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/CIFAR-10/inception_v4/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the job script and log file.
#[LYW]
job_dir = "jobs/CIFAR-10/inception_v4/{}".format(job_name)#job_dir = "jobs/VGGNet/KITTI/{}".format(job_name)
...
Inception_v4_2_PreActRes_Conv3x3_basic_Cifar10(net,from_layer='data',global_pool=True)
