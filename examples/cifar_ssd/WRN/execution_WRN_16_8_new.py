...
job_name = "WRN_16_8_Nesterov_new"
...
max_iter = 78200#64000

#src/caffe/proto/caffe.proto 
solver_param = {
    # Train parameters
    'base_lr': base_lr,
    'weight_decay': 0.0005,#0.0001, #0.0005
    'lr_policy': "step",
    'power':0.9,
    'stepsize': 23460,    
    #'stepvalue': 48000,
...
WRN_16_8_cifar10(net,from_layer='data',global_pool=True)
