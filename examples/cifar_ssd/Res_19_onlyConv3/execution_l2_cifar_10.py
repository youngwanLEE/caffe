...
job_name = "resnet_19_conv3x3_only_l2"
...
ResNet19_Conv3x3_l2_Cifar10(net,from_layer='data',global_pool=True)
...
net.data, net.label = CreateAnnotatedDataLayerLEVELDB(test_data, batch_size=test_batch_size,
