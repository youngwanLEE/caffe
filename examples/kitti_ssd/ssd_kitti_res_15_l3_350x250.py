...
#[LYW]
job_name = "SSD_Res_15L_l3_ASP4_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/resnet_15_conv3x3_basic_l3_SGDR/cifar_10_resnet_15_conv3x3_basic_l3_SGDR_iter_13004.caffemodel" #[LYW]
# Stores LabelMapItem.
...
ResNet_15_Conv3x3_basic_l3_SSD(net, from_layer='data',global_pool=False)
...
ResNet_15_Conv3x3_basic_l3_SSD(net, from_layer='data',global_pool=False) #using 50L model
