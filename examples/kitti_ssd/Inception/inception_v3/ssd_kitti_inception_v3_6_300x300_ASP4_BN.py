...
#[LYW]
job_name = "SSD_Inception_v3_6_preActRes_ASP4_BN_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v3/inception_v3_6_PreactRes_cifar10/cifar_10_inception_v3_6_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_v3_6_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False)
...
Inception_v3_6_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False) #using 50L model
