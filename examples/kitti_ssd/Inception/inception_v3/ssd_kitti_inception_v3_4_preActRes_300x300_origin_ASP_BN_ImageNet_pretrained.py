...
#[LYW]
job_name = "SSD_Inception_v3_4_preActRes_OriginASP_BN_ImageNet_pretrained_unFreezed_4th_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
#[LYW]
save_dir = "models/New/KITTI/inception_v3/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/New/KITTI/inception_v3/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the job script and log file.
#[LYW]
job_dir = "jobs/New/KITTI/inception_v3/{}".format(job_name)#job_dir = "jobs/VGGNet/KITTI/{}".format(job_name)
...
pretrain_model = "models/ImageNet/inception_v3_4_preActRes/ImageNet_inception_v3_4_preActRes_iter_100000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_v3_4_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False,freeze_layers=freeze_layers)
