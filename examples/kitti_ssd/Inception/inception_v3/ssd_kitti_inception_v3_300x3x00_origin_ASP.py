...
#[LYW]
job_name = "SSD_Inception_v3_Res_basic_OriginASP_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v3/inception_v3_PreactRes_cifar10/cifar_10_inception_v3_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
