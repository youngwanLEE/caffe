...
#[LYW]
job_name = "SSD_Inception_v3_4_preActRes_basic_OriginASP_BN_cifar10_pretrained_2nd{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v3/inception_v3_4_PreactRes_cifar10/cifar_10_inception_v3_4_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
