...
#[LYW]
job_name = "SSD_Inception_v3_2nd_preActRes_OriginASP_BN_cifar10_pretrained_2nd_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v3/inception_v3_PreactRes_cifar10_2nd/cifar_10_inception_v3_PreactRes_cifar10_2nd_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
mbox_source_layers = ['inception_3a', 'bn_res4b_relu', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
Inception_v3_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False)
...
Inception_v3_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False) #using 50L model
