...
#[LYW]
job_name = "SSD_Inception_v2_Res_l2_ASP4_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_res_l2_cifar10/cifar_10_inception_v2_res_l2_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_v2_Res_Conv3x3_basic_l2_SSD(net, from_layer='data',global_pool=False) #using 50L model
