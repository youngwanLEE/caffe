...
#[LYW]
job_name = "SSD_Inception_v2_7_preActRes_OriginASP_BN_cifar10_pretrained_4th_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_7_PreactRes_cifar10/cifar_10_inception_v2_7_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
