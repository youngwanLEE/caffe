...
#[LYW]
job_name = "SSD_Inception_v2_2_Res_l2_OriginASP_BN_ImageNet_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/ImageNet/inception_v2/ImageNet_inception_v2_2_preActRes_l2/ImageNet_inception_v2_2_preActRes_l2_iter_100000.caffemodel" #[LYW]
# Stores LabelMapItem.
