...
train_data = "/home/cvlab/data/kitti_ssd_ped3/kitti_ssd_trainval_lmdb"
test_data = "/home/cvlab/data/kitti_full/kitti_ssd_test_lmdb"
...
#[LYW]
job_name = "SSD_Inception_v2_4_Res_l2_OriginASP_BN_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_4_PreactRes_l2_cifar10/cifar_10_inception_v2_4_PreactRes_l2_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_v2_4_PreActRes_Conv3x3_basic_l2_SSD(net, from_layer='data',global_pool=False)
...
Inception_v2_4_PreActRes_Conv3x3_basic_l2_SSD(net, from_layer='data',global_pool=False) #using 50L model
