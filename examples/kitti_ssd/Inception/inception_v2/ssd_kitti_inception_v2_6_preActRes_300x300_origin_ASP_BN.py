...
#[LYW]
job_name = "SSD_Inception_v2_6_preActRes_OriginASP_BN_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_6_PreactRes_cifar10/cifar_10_inception_v2_6_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
mbox_source_layers = ['bn4a_root_relu', 'bn_inception_4b_relu', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
Inception_v2_7_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False)
...
Inception_v2_7_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False) #using 50L model
