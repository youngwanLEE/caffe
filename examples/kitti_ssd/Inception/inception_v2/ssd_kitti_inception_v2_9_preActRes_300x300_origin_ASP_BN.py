...
#[LYW]
job_name = "SSD_Inception_v2_9_preActRes_OriginASP_BN_cifar10_pretrained_2nd_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
#[LYW]
save_dir = "models/New/KITTI/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/New/KITTI/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the job script and log file.
#[LYW]
job_dir = "jobs/New/KITTI/{}".format(job_name)#job_dir = "jobs/VGGNet/KITTI/{}".format(job_name)
...
#pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_9_PreactRes_cifar10/cifar_10_inception_v2_9_PreactRes_cifar10_iter_64000.caffemodel" #[LYW]
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_9_PreactRes_cifar10/cifar_10_inception_v2_9_PreactRes_cifar10_iter_23.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_v2_9_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False)
...
Inception_v2_9_PreActRes_Conv3x3_basic_SSD(net, from_layer='data',global_pool=False) #using 50L model
