...
train_data = "/home/youngwan/data/kitti_trainVal/kitti_ssd_trainval_lmdb"
...
#[LYW]
job_name = "SSD_Inception_v2_2_preActRes_l2_OriginASP_ImageNet_pretrained_K_Freezed{}".format(resize)#job_name = "SSD_{}".format(resize)
# The name of the model. Modify it if you want.
#[LYW]
model_name = "KITTI_{}".format(job_name) #model_name = "VGG_KITTI_{}".format(job_name)

# Directory which stores the model .prototxt file.
#[LYW]
save_dir = "models/New/KITTI/inception_v2/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/New/KITTI/inception_v2/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the job script and log file.
#[LYW]
job_dir = "jobs/New/KITTI/inception_v2/{}".format(job_name)#job_dir = "jobs/VGGNet/KITTI/{}".format(job_name)
...
name_size_file = "data/kitti_ssd/test_name_size.txt" 
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
#pretrain_model = "models/ResNet/ResNet-50-model.caffemodel" #[LYW]
#pretrain_model = "models/ImageNet/inception_v2_res_l2/ImageNet_inception_v2_res_l2_iter_100000.caffemodel" #[LYW]
pretrain_model = "models/ImageNet/inception_v2/inception_v2_2_preActRes_l2/ImageNet_inception_v2_2_preActRes_l2_iter_100000.caffemodel" #[LYW]
# Stores LabelMapItem.
label_map_file = "data/kitti_ssd/labelmap_kitti.prototxt"
...
mbox_source_layers = ['bn4a_root_relu', 'bn_res4b_relu', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
# Which layers to freeze (no backward) during training for Inception_v2_2(#[LYW]).
freeze_layers = ['conv_1','conv2a_branch2a','conv2a_proj','conv2a_branch2b','conv2b_branch2a','conv2b_branch2b']
...
Inception_v2_2_PreActRes_Conv3x3_basic_l2_SSD(net, from_layer='data',global_pool=False,freeze_layers=freeze_layers)
...
Inception_v2_2_PreActRes_Conv3x3_basic_l2_SSD(net, from_layer='data',global_pool=False,freeze_layers=freeze_layers) #using 50L model
