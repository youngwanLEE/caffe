...
#[LYW]
job_name = "SSD_Inception_v2_4_preActRes_l2_ASP4_PED3_BN_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
max_sizes = [[]] + max_sizes
aspect_ratios = [[2,3], [2, 3, 4], [2, 3, 4], [2, 3, 4], [2, 3, 4], [2, 3]]
