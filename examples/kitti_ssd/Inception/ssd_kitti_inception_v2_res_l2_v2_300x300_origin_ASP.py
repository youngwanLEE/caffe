...
#[LYW]
job_name = "SSD_Inception_v2_Res_l2_v2_OriginASP_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_v2/inception_v2_PreactRes_l2_v2_cifar10/cifar_10_inception_v2_PreactRes_l2_v2_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
mbox_source_layers = ['inception_3a_relu', 'bn_res4b_relu', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
Inception_v2_PreActRes_Conv3x3_basic_l2_v2_SSD(net, from_layer='data',global_pool=False)
...
Inception_v2_PreActRes_Conv3x3_basic_l2_v2_SSD(net, from_layer='data',global_pool=False) #using 50L model
