...
#[LYW]
job_name = "SSD_Inception_Res_l3_ASP234_cifar10Pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_res_l3_cifar10/cifar_10_inception_res_l3_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
mbox_source_layers = ['inception_3a_relu', 'res4b_relu', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
Inception_Res_Conv3x3_basic_l3_SSD(net, from_layer='data',global_pool=False)
...
Inception_Res_Conv3x3_basic_l3_SSD(net, from_layer='data',global_pool=False) #using 50L model
