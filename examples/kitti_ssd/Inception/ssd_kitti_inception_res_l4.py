...
#[LYW]
job_name = "SSD_Inception_Res_l4_ASP4_cifar10Pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/inception_res_l4_cifar10/cifar_10_inception_res_l4_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
Inception_Res_Conv3x3_basic_l4_SSD(net, from_layer='data',global_pool=False)
...
Inception_Res_Conv3x3_basic_l4_SSD(net, from_layer='data',global_pool=False) #using 50L model
