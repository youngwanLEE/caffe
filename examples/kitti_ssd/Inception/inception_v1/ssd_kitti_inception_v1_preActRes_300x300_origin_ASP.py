...
#[LYW]
job_name = "SSD_Inception_v1_preActRes_OriginASP_cifar10_pretrained_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
#[LYW]
save_dir = "models/New/KITTI/inception_v1/{}".format(job_name)#save_dir = "models/VGGNet/KITTI/{}".format(job_name)
# Directory which stores the snapshot of models.
#[LYW]
snapshot_dir = "models/New/KITTI/inception_v1/{}".format(job_name)#snapshot_dir = "models/VGGNet/KITTI/{}".format(job_name)
...
pretrain_model = "models/CIFAR-10/inception_v1/inception_v1_PreactRes_cifar10/cifar_10_inception_v2_PreactRes_l2_cifar10_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
