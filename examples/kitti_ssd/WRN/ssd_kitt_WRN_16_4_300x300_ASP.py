...
#[LYW]
job_name = "SSD_WRN_16_4_OriginASP_cifar_pretrained_3rd{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/WRN_16_4_Nesterov_new/cifar_10_WRN_16_4_Nesterov_new_iter_78200.caffemodel" #[LYW]
# Stores LabelMapItem.
...
WRN_16_4_SSD(net, from_layer='data',global_pool=False)
...
WRN_16_4_SSD(net, from_layer='data',global_pool=False) #using 50L model
