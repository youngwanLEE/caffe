...
train_data = "/home/youngwan/data/kitti_full/kitti_ssd_trainval_lmdb"
...
#[LYW]
job_name = "SSD_PreActiv_Res_15L_l4_ASP4_{}".format(resize)#job_name = "SSD_{}".format(resize)
...
pretrain_model = "models/CIFAR-10/preActiv_resnet_15_basic_l4_SGDR/cifar_10_preActiv_resnet_15_basic_l4_SGDR_iter_64000.caffemodel" #[LYW]
# Stores LabelMapItem.
...
mbox_source_layers = ['res3b', 'res4b', 'conv6_2', 'conv7_2', 'conv8_2', 'pool6']
...
PreActiv_ResNet_15_Conv3x3_basic_l4_SSD(net, from_layer='data',global_pool=False)
...
PreActiv_ResNet_15_Conv3x3_basic_l4_SSD(net, from_layer='data',global_pool=False) #using 50L model
