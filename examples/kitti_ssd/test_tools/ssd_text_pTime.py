...
job_name = "SSD_PreActiv_Res_15L_l4_ASP4_{}".format(resize)
save_dir = "jobs/New/KITTI/{}".format(job_name)
...
for c in xrange(1,2,1) :
    ...
    result_path = '{}/Result_full_lmdb_text_{}'.format(save_dir,conf_th)
    make_if_not_exist(result_path)
    
    image_list = os.listdir("/home/youngwan/data/KITTI/kitti_test_imgs")
    sorted_list = sorted(image_list)

    for s in sorted_list:
        loadingfile = '/home/youngwan/data/KITTI/kitti_test_imgs/' + s
